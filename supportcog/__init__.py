...
class SupportCog(commands.Cog):
    ...
    async def ticketset_category(self, ctx: commands.Context, *, category: str = None):
        """Setzt die Kategorie, in der Ticket-Channels erstellt werden. 'reset' zum Zurücksetzen."""
